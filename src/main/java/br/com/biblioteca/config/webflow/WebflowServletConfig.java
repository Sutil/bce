package br.com.biblioteca.config.webflow;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "br.com.biblioteca.app", scopedProxy = ScopedProxyMode.TARGET_CLASS, useDefaultFilters = false, includeFilters = {
